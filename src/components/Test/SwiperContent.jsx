        ...
        <>
            ...
            <div className='w-full h-screen flex flex-row justify-center items-center'>
                ...
                <div className={`w-full h-screen flex flex-row justify-between items-start mx-40 pt-20`}>
                        ...
                        <div className="">
                            ...
                            >
                                <div className={lang === 'ar' ? 'pr-52' : 'pl-52'}>
                                    <TextAnimation el="h1" className='text-main text-[1.6vw] mb-2 font-bold pt-10' text="أهداف تحسين تجربة الحاج في الوصول للسكن" />
                                </div>
                    ...
                    <motion.div className="content mt-40 w-[40vw] flex flex-row justify-end"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        transition={{ duration: duration, ease: ease, delay: startDelay + 3 }}
                    >
