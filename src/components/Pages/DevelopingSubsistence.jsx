                            ...
                            <div className="list">
                                ...
                                >
                                    ...
                                    <div className="text mx-[0.8vw]">
                                        <TextAnimation el="strong" className='text-main font-bold' text=" متابعة تأهيل وتقديم التغذية من المتعهدين في المشاعر " elDelay={startDelay + 4} />
                                        <TextAnimation el="p" className='mt-2' text="يضمن النظام الرقمي تأهيل ومتابعة المتعهدين وفق مواصفات ومعايير محددة لضمان حصول ضيوف الرحمن على أفضل خدمة." elDelay={startDelay + 5} />
                                    </div>
                                </motion.div>
                                ...
                                >
                                    ...
                                    />
                                    <div className="text mx-[0.8vw]">
                                        <TextAnimation el="strong" className='text-main font-bold' text="حصول الحجاج على الغذاء الخاص بهم بموعده" elDelay={startDelay + 6} />
                                        <TextAnimation el="p" className='mt-2' text="يضمن النظام الرقمي متابعة تسليم الوجبات في الوقت المحدد للحجاج دون التأخر عن موعدها." elDelay={startDelay + 7} />
                                    </div>
                                </motion.div>
                                <motion.div className='text-white/85 text-[1vw] mb-[1.3vw] font-light leading-30 flex items-start'
                                    variants={listAnimate}
                                ...
                                >
                                    ...
                                    />
                                    <div className="text mx-[0.8vw]">
                                        <TextAnimation el="strong" className='text-main font-bold' text="حصول الحجاج على الغذاء الخاص بهم مطابق للجودة والمعايير" elDelay={startDelay + 8} />
                    ...
                    <div className="content w-[40vw] flex flex-row justify-end">
                        <div className="content">
                            ...
                            <div className="flex flex-row justify-between items-center mt-10">
                                ...
                                >
                                    <img src={process.env.PUBLIC_URL + '/images/sup_pages/eaasha-03.jpg'} className="w-full" alt="" />
                                </motion.div>
