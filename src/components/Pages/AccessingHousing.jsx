                            ...
                            <div className="list">
                                ...
                                >
                                    ...
                                    <div className="text mx-[0.8vw]">
                                        <TextAnimation el="strong" className='text-main font-bold' text="توفير معلومات لوجستية دقيقة للحجاج" elDelay={startDelay + 4} />
                                        <TextAnimation el="p" className='mt-2' text="إتاحة معلومات دقيقة وحديثة عن مكان السكن الصحيح، بما في ذلك العنوان والموقع ووسائل الوصول." elDelay={startDelay + 5} />
                                    </div>
                                </motion.div>
                    ...
                    <div className="content w-[40vw] flex flex-row justify-end">
                        <div className="content">
                            ...
                            <div className="flex flex-row justify-between items-center mt-10">
                                ...
                                >
                                    <img src={process.env.PUBLIC_URL + '/images/sup_pages/happy.jpg'} className="w-full" alt="" />
                                </motion.div>
